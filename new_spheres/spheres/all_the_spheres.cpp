...
glutPostRedisplay();
    ...
    glLoadIdentity(); // Load the Identity Matrix to reset our drawing locations
      ...
      camera();
		 ...
		 dragonfly.render();
		 glPopMatrix();
  gluLookAt( 20, 20, 50,0,0,1,0.0f, 1.0f, 0.0f);
							...
							if(play){
								...
								t+=0.1;
									...
									glRotatef(PLangle, 0.0f, 1.0f, 0.0f);
										 glTranslatef(x,0,0);
										glColor3f(1,.0,1);
										gluSphere(quadratic,.5,16,16);
									glPopMatrix();
									 //purple light mesh
									glPushMatrix();
									glRotatef(180,1,0,0);
									glRotatef(PLangle+10, 0.0f, 1.0f, 0.0f);
										 glTranslatef(x,x,0);
										glColor3f(1,.0,1);
										gluSphere(quadratic,.55,16,16);
									glPopMatrix();
									 //purple light mesh
									glPushMatrix();
									glRotatef(180,0,0,1);
									glRotatef(PLangle+10, 0.0f, 1.0f, 0.0f);
										 glTranslatef(x-12,0,0);
										glColor3f(1,.0,1);
										gluSphere(quadratic,.38,16,16);
									glPopMatrix();
									//blue light mesh
									glPushMatrix();
									glRotatef(-100,1,0,1);
                        ...
                        if(play){
							...
							t+=0.1;
								...
								glRotatef(WCangle-8, 0.0f, 1.0f, 0.0f);
									 glTranslatef(x-6,3,-2);
									glColor3f(1,.1,0);
									gluSphere(quadratic,.66,16,16);
								glPopMatrix();
						glPopMatrix();
                        }
                        glPopMatrix();
